...
class ElasticTrainingServicer(elastic_training_pb2_grpc.ElasticTrainingServiceServicer):
    ...
    def IsReadyScaling(self, request, context):
        ...
        resp.scaling_action = elastic_training_pb2.SCALING_UP
        resp.ps_num = 6
        mutex.acquire()
        self._count += 1
        mutex.release()
    ...
    def ReadyToUpdate(self, request, context):
        cluster_json = {"cluster": {"ps": ["localhost:10086", "localhost:10087", "localhost:10088", "localhost:10089", "localhost:10090", "localhost:10091"]}}
